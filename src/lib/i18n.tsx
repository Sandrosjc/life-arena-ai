...
const pt: Dict = {
  ...
  adCountdown: "Termina em {s}s",
  adDone: "Pronto!",
  adContinue: "Continuar",
  adRewardHint: "Assista até o fim e ganhe 1 vida!",
  adBreakHint: "Uma pausa rapidinha — o vídeo libera sua próxima fase.",
  planMonthly: "Mensal",
  planQuarterly: "Trimestral",
  planYearly: "Anual",
  planPerMonth: "por mês",
  planPopular: "POPULAR",
  planBestDeal: "MELHOR OFERTA",
  planSave: "economize {pct}%",
  planVsDuolingo: "60% mais barato que o Duolingo",
  planYearlyHook: "Menos que 1 lanche por mês",
  planBilled: "cobrado {price}",
};
...
const es: Dict = {
  ...
  adCountdown: "Termina en {s}s",
  adDone: "¡Listo!",
  adContinue: "Continuar",
  adRewardHint: "¡Mira hasta el final y gana 1 vida!",
  adBreakHint: "Una pausa rapidita — el video libera tu próxima fase.",
  planMonthly: "Mensual",
  planQuarterly: "Trimestral",
  planYearly: "Anual",
  planPerMonth: "al mes",
  planPopular: "POPULAR",
  planBestDeal: "MEJOR OFERTA",
  planSave: "ahorra {pct}%",
  planVsDuolingo: "60% más barato que Duolingo",
  planYearlyHook: "Menos que 1 merienda al mes",
  planBilled: "cobrado {price}",
};
...
const en: Dict = {
  ...
  adCountdown: "Ends in {s}s",
  adDone: "Done!",
  adContinue: "Continue",
  adRewardHint: "Watch until the end to earn 1 heart!",
  adBreakHint: "A quick break — the video unlocks your next stage.",
  planMonthly: "Monthly",
  planQuarterly: "Quarterly",
  planYearly: "Yearly",
  planPerMonth: "/month",
  planPopular: "POPULAR",
  planBestDeal: "BEST DEAL",
  planSave: "save {pct}%",
  planVsDuolingo: "60% cheaper than Duolingo",
  planYearlyHook: "Less than 1 snack a month",
  planBilled: "billed {price}",
};
